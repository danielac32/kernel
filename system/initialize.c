...
void nullprocess(void) {
	//kprintf("nullprocess start\n");
	//resume(create((void *)main, 4096, INITPRIO, "Main Process", 0, NULL));
	resume(create(shell, 4096, 50, "shell", 1, 0));
	resume(create((void *)blink, 1024, INITPRIO, "blink", 0, NULL));
	//resume(create((void *)button, 1024, INITPRIO, "button", 0, NULL));
	resume(create((int *)test_funct, 4096, INITPRIO, "test", 0, NULL));
...
void sys(int INIT, struct procent *p) {
